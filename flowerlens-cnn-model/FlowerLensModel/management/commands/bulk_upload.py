...
from FlowerLensModel.models import TrainFlower, FlowerClasses
    ...
    def handle(self, *args, **kwargs):
        ...
        for flower_class_dir in root_path.iterdir():
            if flower_class_dir.is_dir():
                ...
                flower_class, created = FlowerClasses.objects.get_or_create(name=flower_class_name)

                for image_path in flower_class_dir.glob('*.jpg'):
                    with open(image_path, 'rb') as image_file:
                        flower_image = TrainFlower(flower=flower_class)  # Create a FlowerImage instance
